...
import {StatusCodeCreated, StatusCodeBadRequest, StatusCodeForbidden} from '../constants';

describe('api > runs > create', () => {
    let testTeam;
    let testUser;
    let testPlaybook;
    ...
    describe('in an existing, public channel', () => {
        it('with no team_id specified', () => {
            ...
            cy.apiCreateChannel(testTeam.id, 'channel', 'Channel').then(({channel}) => {
                ...
                }, {expectedStatusCode: StatusCodeCreated}).then((body) => {
        ...
        it('with wrong team_id specified', () => {
            ...
            cy.apiCreateChannel(testTeam.id, 'channel', 'Channel').then(({channel}) => {
                ...
                }, {expectedStatusCode: StatusCodeBadRequest}).then((body) => {
    ...
    it('in an existing, private channel, of which the user is not a member', () => {
        ...
        cy.apiCreateChannel(testTeam.id, 'channel', 'Channel', 'P').then(({channel}) => {
            ...
            cy.apiRunPlaybook({
                ...
                playbookId: testPlaybook.id,
                teamId: testTeam.id,
            }, {expectedStatusCode: StatusCodeForbidden}).then((body) => {
                expect(body).to.have.property('error', 'unable to create playbook run');
            });
        });
    });
