...
describe('AssigneeDropdown', () => {
    ...
    it('shows resolved user with badge in run mode when assignee_type is property_user', () => {
        ...
        const fields = [makeUserField('f1', 'Manager')];
        const values = [{id: 'v1', field_id: 'f1', value: 'user-1', create_at: 0, update_at: 0, delete_at: 0}];
    ...
    it('does not show non-user property fields in the attribute sub-dropdown', () => {
        ...
        const fields = [
            ...
            {id: 'f2', group_id: '', name: 'Priority', type: PropertyFieldType.Select, attrs: {visibility: 'always' as const, sort_order: 0, options: null}, create_at: 0, update_at: 0, delete_at: 0},
        ];
