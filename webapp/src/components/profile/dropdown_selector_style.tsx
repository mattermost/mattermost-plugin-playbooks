...
export const DropdownSelectorStyle = styled.div`
    ...
    .playbook-run-user-select__input {
    ...
    .playbook-run-user-select__option--is-selected {
        background-color: var(--center-channel-color-08);
    }

    .playbook-run-user-select__option--is-focused {
        background-color: var(--center-channel-color-08);
        color: inherit;
    }

    .playbook-run-user-select__control {
        margin: 12px;
        border: none;
    ...
    .playbook-run-user-select__option {
        &:active {
            background-color: var(--center-channel-color-08);
        }
    }

    .playbook-run-user-select__value-container {
        overflow: visible;
        padding-left: 3.2rem;
