...
import {getProfilesByIds} from 'mattermost-redux/src/actions/users';
import {UserProfile} from '@mattermost/types/users';
import {sortByUsername} from 'mattermost-redux/src/utils/user_utils';
import {getCurrentUser} from 'mattermost-redux/src/selectors/entities/users';
