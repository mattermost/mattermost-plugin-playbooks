...
export type PlaybookRunReminderQuery = { __typename?: 'Query', run?: { __typename?: 'Run', id: string, name: string, reminderPostId: string, reminderMessageTemplate: string, previousReminder: number, reminderTimerDefaultSeconds: number } | null };
