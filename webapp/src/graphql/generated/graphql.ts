...
export type ChecklistItem = {
  ...
  assigneeGroupID: Scalars['String'];
  ...
  restrictCompletionToAssignee: Scalars['Boolean'];
...
export type ChecklistItemUpdates = {
  assigneeGroupID?: InputMaybe<Scalars['String']>;
  assigneeID: Scalars['String'];
  assigneeModified: Scalars['Float'];
  ...
  description: Scalars['String'];
  dueDate: Scalars['Float'];
  restrictCompletionToAssignee?: InputMaybe<Scalars['Boolean']>;
  state: Scalars['String'];
  stateModified: Scalars['Float'];
...
export type CreationRuleInput = {
  condition?: InputMaybe<Scalars['JSON']>;
  inviteUserIDs?: InputMaybe<Array<Scalars['String']>>;
  setChannelID?: InputMaybe<Scalars['String']>;
  setOwnerID?: InputMaybe<Scalars['String']>;
};
...
export type Playbook = {
  ...
  adminOnlyEdit: Scalars['Boolean'];
  autoArchiveChannel: Scalars['Boolean'];
  ...
  newChannelOnly: Scalars['Boolean'];
  nextRunNumber: Scalars['Float'];
  numRuns: Scalars['Int'];
  ...
  runNumberPrefix: Scalars['String'];
...
export type PlaybookUpdates = {
  adminOnlyEdit?: InputMaybe<Scalars['Boolean']>;
  autoArchiveChannel?: InputMaybe<Scalars['Boolean']>;
  ...
  creationRules?: InputMaybe<Array<CreationRuleInput>>;
  ...
  newChannelOnly?: InputMaybe<Scalars['Boolean']>;
  ownerGroupOnlyActions?: InputMaybe<Scalars['Boolean']>;
...
export type PlaybookQuery = { __typename?: 'Query', playbook?: { __typename?: 'Playbook', id: string, title: string, description: string, public: boolean, team_id: string, delete_at: number, default_playbook_member_role: string, invited_user_ids: Array<string>, invited_group_ids: Array<string>, broadcast_channel_ids: Array<string>, webhook_on_creation_urls: Array<string>, reminder_timer_default_seconds: number, reminder_message_template: string, broadcast_enabled: boolean, webhook_on_status_update_enabled: boolean, webhook_on_status_update_urls: Array<string>, status_update_enabled: boolean, retrospective_enabled: boolean, retrospective_reminder_interval_seconds: number, retrospective_template: string, default_owner_id: string, run_summary_template: string, run_summary_template_enabled: boolean, message_on_join: string, category_name: string, invite_users_enabled: boolean, default_owner_enabled: boolean, webhook_on_creation_enabled: boolean, message_on_join_enabled: boolean, categorize_channel_enabled: boolean, signal_any_keywords_enabled: boolean, signal_any_keywords: Array<string>, create_public_playbook_run: boolean, channel_name_template: string, run_number_prefix: string, next_run_number: number, create_channel_member_on_new_participant: boolean, remove_channel_member_on_removed_participant: boolean, channel_id: string, channel_mode: string, owner_group_only_actions: boolean, admin_only_edit: boolean, new_channel_only: boolean, auto_archive_channel: boolean, creation_rules: any, is_favorite: boolean, checklists: Array<{ __typename?: 'Checklist', title: string, items: Array<{ __typename?: 'ChecklistItem', title: string, description: string, state: string, command: string, state_modified: number, assignee_id: string, assignee_type: string, assignee_modified: number, command_last_run: number, due_date: number, condition_id: string, condition_action: string, condition_reason: string, restrict_completion_to_assignee: boolean, assignee_group_id: string, assignee_property_field_id: string, task_actions: Array<{ __typename?: 'TaskAction', trigger: { __typename?: 'Trigger', type: string, payload: string }, actions: Array<{ __typename?: 'Action', type: string, payload: string }> }> }> }>, members: Array<{ __typename?: 'Member', roles: Array<string>, user_id: string, scheme_roles: Array<string> }>, metrics: Array<{ __typename?: 'PlaybookMetricConfig', id: string, title: string, description: string, type: MetricType, target?: number | null }>, propertyFields: Array<{ __typename?: 'PropertyField', id: string, name: string, type: PropertyFieldType, group_id: string, attrs: { __typename?: 'PropertyFieldAttrs', visibility: string, sort_order: number, value_type?: string | null, options?: Array<{ __typename?: 'PropertyOption', id: string, name: string, color?: string | null }> | null } }> } | null };
...
export type SetItemPropertyUserAssigneeMutationVariables = Exact<{
  runID: Scalars['String'];
  checklistNum: Scalars['Float'];
  itemNum: Scalars['Float'];
  propertyFieldID: Scalars['String'];
...
export type SetItemPropertyUserAssigneeMutation = { __typename?: 'Mutation', setItemPropertyUserAssignee: string };
...
export const SetItemPropertyUserAssigneeDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"SetItemPropertyUserAssignee"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"runID"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"checklistNum"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"Float"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"itemNum"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"Float"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"propertyFieldID"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"setItemPropertyUserAssignee"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"runID"},"value":{"kind":"Variable","name":{"kind":"Name","value":"runID"}}},{"kind":"Argument","name":{"kind":"Name","value":"checklistNum"},"value":{"kind":"Variable","name":{"kind":"Name","value":"checklistNum"}}},{"kind":"Argument","name":{"kind":"Name","value":"itemNum"},"value":{"kind":"Variable","name":{"kind":"Name","value":"itemNum"}}},{"kind":"Argument","name":{"kind":"Name","value":"propertyFieldID"},"value":{"kind":"Variable","name":{"kind":"Name","value":"propertyFieldID"}}}]}]}}]} as unknown as DocumentNode<SetItemPropertyUserAssigneeMutation, SetItemPropertyUserAssigneeMutationVariables>;