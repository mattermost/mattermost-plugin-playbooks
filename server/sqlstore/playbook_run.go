...
func (s *playbookRunStore) NukeDB() (err error) {
	...
	if _, err := tx.Exec("DROP TABLE IF EXISTS IR_PlaybookMember, IR_Run_Participants, PlaybookAutoFollowers, IR_StatusPosts, IR_TimelineEvent, IR_Incident, IR_Playbook, IR_System"); err != nil {
