...
func (m *MockService) EndIncident(arg0 string) (*incident.Incident, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "EndIncident", arg0)
	ret0, _ := ret[0].(*incident.Incident)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockServiceMockRecorder) EndIncident(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "EndIncident", reflect.TypeOf((*MockService)(nil).EndIncident), arg0)
}

// GetAllHeaders mocks base method
func (m *MockService) GetAllHeaders() ([]incident.Header, error) {
	m.ctrl.T.Helper()
...
func (mr *MockServiceMockRecorder) GetAllHeaders() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetAllHeaders", reflect.TypeOf((*MockService)(nil).GetAllHeaders))
}
