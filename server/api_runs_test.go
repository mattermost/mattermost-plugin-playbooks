...
func TestFinishedRunWriteOperationsBlocked(t *testing.T) {
	...
	t.Run("change owner fails", func(t *testing.T) {
		...
		resp, err := e.ServerClient.DoAPIRequestWithHeaders(context.Background(), http.MethodPost,
	...
	t.Run("restore succeeds", func(t *testing.T) {
		...
		resp, err := e.ServerClient.DoAPIRequestWithHeaders(context.Background(), http.MethodPut,
