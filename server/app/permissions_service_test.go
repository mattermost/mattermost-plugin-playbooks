...
func (s *stubPlaybookService) UpdateChannelNameTemplateOverrideAllowed(string, bool, string) error {
	panic("stubPlaybookService: UpdateChannelNameTemplateOverrideAllowed not implemented")
}
