...
func (m *MockChannelActionService) Update(arg0 app.GenericChannelAction, arg1 string) error {
	m.ctrl.T.Helper()
...
func (mr *MockChannelActionServiceMockRecorder) Update(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Update", reflect.TypeOf((*MockChannelActionService)(nil).Update), arg0, arg1)
}
