...
var sentinelErrors = []sentinelError{
	...
	{app.ErrPropertyFieldNotOnRun, http.StatusBadRequest, "Property field does not belong to this run."},
	...
	{app.ErrReservedPropertyFieldName, http.StatusBadRequest, "This property field name is reserved."},
