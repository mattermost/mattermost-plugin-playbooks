...
func (m *MockService) GetPlaybooksForTeam(arg0 string, arg1 playbook.Options) ([]playbook.Playbook, error) {
	m.ctrl.T.Helper()
...
func (mr *MockServiceMockRecorder) GetPlaybooksForTeam(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetPlaybooksForTeam", reflect.TypeOf((*MockService)(nil).GetPlaybooksForTeam), arg0, arg1)
}
