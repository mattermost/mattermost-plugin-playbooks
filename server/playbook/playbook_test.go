...
func TestPlaybook_MarshalJSON(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			expected: []byte(`{"id":"playbookid","title":"the playbook title","description":"the playbook's description","team_id":"theteamid","create_public_incident":true,"create_at":4503134,"delete_at":0,"num_stages":0,"num_steps":0,"checklists":[],"member_ids":[],"broadcast_channel_id":"channelid","reminder_message_template":"This is a message","reminder_timer_default_seconds":0,"invited_user_ids":[],"invited_group_ids":[],"invite_users_enabled":false,"default_commander_id":"","default_commander_enabled":false,"announcement_channel_id":"","announcement_channel_enabled":false,"webhook_on_creation_url":"","webhook_on_creation_enabled":false,"message_on_join":"","webhook_on_archive_url":"","webhook_on_archive_enabled":false,"message_on_join_enabled":false}`),
			wantErr:  false,
		},
		{
