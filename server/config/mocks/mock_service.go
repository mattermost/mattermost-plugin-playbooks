...
// Source: github.com/mattermost/mattermost-plugin-playbooks/v2/server/config (interfaces: Service)
...
import (
	...
	config "github.com/mattermost/mattermost-plugin-playbooks/v2/server/config"
