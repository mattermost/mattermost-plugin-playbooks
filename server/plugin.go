...
func (p *Plugin) OnActivate() error {
	...
	userInfoService := app.NewUserInfoService(userInfoStore)
	...
	api.NewBotHandler(p.handler.APIRouter, pluginAPIClient, p.bot, p.bot, p.config, p.playbookRunService, userInfoService)
