 ...
 * @filename - Name of a plugin file which should be available at "e2e-tests/cypress/tests/fixtures/[filename]"
 ...
 * Download the plugin file from the given "@url" and save to "e2e-tests/cypress/tests/fixtures/[@filename]".
