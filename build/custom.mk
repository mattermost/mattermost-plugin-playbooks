...
ifneq ($(HAS_SERVER),)
	...
	mockgen -destination server/playbook/mocks/mock_keywords_ignorer.go github.com/mattermost/mattermost-plugin-incident-collaboration/server/playbook KeywordsIgnorer
