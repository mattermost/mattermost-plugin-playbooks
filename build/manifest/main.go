...
func findManifest() (*model.Manifest, error) {
	...
	if err != nil {
		return nil, errors.Wrapf(err, "failed to find manifest in current working directory")
	}
...
func applyManifest(manifest *model.Manifest) error {
	if manifest.HasServer() {
		...
		if err := ioutil.WriteFile(
			...
			return errors.Wrapf(err, "failed to write server/manifest.go")
		}
	}
	...
	if manifest.HasWebapp() {
		...
		if err := ioutil.WriteFile(
			...
			return errors.Wrapf(err, "failed to open webapp/src/manifest.js")
		}
	}
